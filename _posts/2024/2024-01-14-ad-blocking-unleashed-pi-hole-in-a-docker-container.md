...
2. **Install Pi-hole and Unbound:**
    ...
    - Install the Unbound recursive DNS resolver. More info on [Unbound DNS](https://github.com/anudeepND/pihole-unbound){:target='_blank'}
...
3. **Add Tailscale into LXC:**
    ...
    **Run Tailscale:**
    ...
    - Initiate Tailscale within the LXC container.
...
4. **Add Pi-hole to your Tailscale nameservers:**
    ...
    - Now you can add your Pi-hole to Tailscale's global nameservers. More info on [Pi-hole and Tailscale](https://tailscale.com/kb/1114/pi-hole){:target='_blank'}
...
6. **Whitelist false positive domains:**
    ...
    - When you add a lot of domains to your adlist there's probability of false positives, so it is recommended to add some commonly white listed domains. Here is the link to an awesome github repository with unattended setup [White List Pi-hole](https://github.com/anudeepND/whitelist){:target='_blank'}.
